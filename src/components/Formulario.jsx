...
//usamos el useEffect para volver los datos al formulario cuando apretamos en el boton editar
        useEffect( () => {
        ...
        const handleSubmit = (e) => {    
            ...
            //Validacion del Formulario, includes verifica que al menos 1 de ellos tenga un string vacio
            ...
            if([nombre,propietario,email,fecha,sintomas].includes('')) {
                ...
                //construir objeto de paciente que viene del formulario
       ...
       return  (
        <div className="md:w-1/2 lg:w-2/5">   
            ...
            className="bg-white shadow-md rounded-lg py-10 px-5 mb-10">
                ...
                <div className="mb-5"> 
                    <label htmlFor="alta" className="block text-gray-600 uppercase font-bold"> Ingreso </label>
                    <input id="alta" 
                    type="date" 
                    className="border-2 w-full p-2 mt-2 placeholder-indigo-400 rounded-md"
                    value={fecha}
            ...
            <input type="submit" className="bg-indigo-600 w-full p-3 text-white uppercase font-bold cursor-pointer" value={paciente.id ? 'Editar Paciente' : 'Agregar Paciente'}/>
